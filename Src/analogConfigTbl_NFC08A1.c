/**
  ...
  * @brief          : This file contains the analog interface
  ******************************************************************************
  * @attention
  *
...
const uint8_t rfalAnalogConfigCustomSettings[] = {
    ...
    MODE_ENTRY_8_REG(0x0008,
        ...
        0x0076,0xf0,0x70, /* AWS enable TX (tentx1) ; Time in fc perionds when driver modulation stops (tr_am dependent) */
        0x0076,0x0f,0x09, /* AWS hard switch at rising edge (tmods2) :  9  fc periods ; Time in fc periods for hard switch between VDD_DR and VDD_AM */
        0x0077,0x0f,0x07  /* AWS soft switch at rising edge (tmodsw2) :  7  fc periods ; Time in fc periods for soft switch between VDD_DR and VDD_AM */
    ),

    /* Mode Name: POLL_A_106_TX, Mode ID: 0x0111 */
    MODE_ENTRY_5_REG(0x0101,
        0x0003,0x04,0x00, /* Transmit AM (tr_am) : OOK ; Use OOK modulation */
        0x0028,0xf0,0xf0, /* AM Modulation Index (am_mod) ; Set modulation index for AWS */
        0x006f,0x20,0x00, /* AWS shaping symmetry (am_sym)  : Nonsymerical shape (for OOK) ; Nonsymmetrical shape(for OOK) */
        0x006f,0x10,0x10, /* AWS enable strong sink (en_modsink) ; Enable strong sink during AWS mod */
        0x006f,0x0f,0x08  /* AWS filter speed (am_filt)  ; Medium AWS filter constant */
    ),
    ...
    MODE_ENTRY_6_REG(0x0141,
        0x0003,0x04,0x04, /* Transmit AM (tr_am) ; Use AM modulation */
        0x0028,0xf0,0xd0, /* AM Modulation Index (am_mod) ; Set Modulation index */
        0x006f,0x0f,0x00, /* AWS filter speed (am_filt)  ; Fast AWS filter constant */
        0x0076,0xf0,0x30, /* AWS enable TX (tentx1) */
        0x0076,0x0f,0x00, /* AWS hard switch at rising edge (tmods2) :  0  fc periods */
        0x0077,0x0f,0x02  /* AWS soft switch at rising edge (tmodsw2) :  2  fc periods */
    ),
    ...
    MODE_ENTRY_5_REG(0x0201,
        0x0003,0x04,0x04, /* Transmit AM (tr_am) ; Use AM modulation  */
        0x0028,0xf0,0x40, /* AM Modulation Index (am_mod) ; Set modulation index */
    ...
    MODE_ENTRY_1_REG(0x0241,
        0x006f,0x0f,0x01  /* AWS filter speed (am_filt)  ; Fast AWS filter constant */
    ),
    ...
    MODE_ENTRY_5_REG(0x0401,
        0x0003,0x04,0x04, /* Transmit AM (tr_am) ; Use AM modulation */
        0x0028,0xf0,0x40, /* AM Modulation Index (am_mod) ; Set Modulation index */
        0x006f,0x20,0x20, /* AWS shaping symmetry (am_sym)  ; Nonsymmetrical shape(for OOK) */
        0x006f,0x10,0x00, /* AWS enable strong sink (en_modsink) : Weak sink ; Enable strong sink during AWS mod */
        0x006f,0x0f,0x08  /* AWS filter speed (am_filt)  ; Medium AWS filter constant */
    ),

    /* Mode Name: POLL_F_COMMON_RX, Mode ID: 0x0402 */
    MODE_ENTRY_6_REG(0x0402,
    ...
    MODE_ENTRY_6_REG(0x10c1,
        0x0003,0x04,0x00, /* Transmit AM (tr_am) : OOK ; Use OOK modulation */
        0x0028,0xf0,0xf0, /* AM Modulation Index (am_mod) ; Set Modulation index for AWS */
        0x0005,0x1e,0x1c, /* Modulation Pulse Width (p_len) ; p_len set to default */
        0x006f,0x20,0x00, /* AWS shaping symmetry (am_sym)  : Nonsymerical shape (for OOK) */
        0x006f,0x10,0x10, /* AWS enable strong sink (en_modsink) */
        0x006f,0x0f,0x06  /* AWS filter speed (am_filt)  ; Medium fast AWS filter constant */
    ),

    /* Mode Name: POLL_V_COMMON_RX, Mode ID: 0x1002 */
    MODE_ENTRY_6_REG(0x1002,
        0x000b,0xff,0x13, /* User Defined */
        0x000c,0xff,0xed, /* Receiver Conf 2 */
        0x000d,0xff,0x00, /* User Defined */
        0x000e,0xff,0x00, /* User Defined */
    ...
    MODE_ENTRY_3_REG(0x0006,
        0x0026,0xff,0x00, /* User Defined ; Set Antenna Tuning (Listener): NFC08A1 */
        0x0027,0xff,0xff, /* User Defined ; Set Antenna Tuning (Listener): NFC08A1 */
    ...
    MODE_ENTRY_1_REG(0x0004,
        0x0068,0x04,0x00  /* AWS regulator shaped AM mod (rgs_am) : Disabled ; Disable AWS during WU */
    ),

    /* Mode Name: WAKEUP_OFF, Mode ID: 0x0005 */
    MODE_ENTRY_1_REG(0x0005,
        0x0068,0x04,0x04  /* AWS regulator shaped AM mod (rgs_am) ; Re-enable AWS after WU */
    )
